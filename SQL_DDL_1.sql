...
-- 10) Ñîçäàòü òàáëèöó roles_employee (id. Serial primary key; employee_id. Int, not null, unique (âíåøíèé êëþ÷ äëÿ òàáëèöû employees, ïîëå id); role_id. Int, not null (âíåøíèé êëþ÷ äëÿ òàáëèöû roles, ïîëå id) )
